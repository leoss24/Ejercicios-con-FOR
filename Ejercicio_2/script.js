/*2. Crea un programa que pregunte al usuario un número. Usando el archivo de arreglo de Pokémons,
 ...
 introducido por el usuario. https://pastebin.com/Zzk8g7Z6. */
 ...
 const usuario = parseInt(prompt("Ingresa un número:"));

 for (let num = 1; num <= usuario; num++){
    if (num % 5 === 0){
        console.log(Pokemons[num - 1]);
    }
 }
